...
async function updateWeatherInfo(city) {
  ...
  await updateForescastsInfo(city);
  showDisplaySection(weatherInfoSection);
}

async function updateForescastsInfo(city) {
  forecastsData = await getFetchData("forecast", city);
...
function showDisplaySection(section) {
  [weatherInfoSection, searchCitySelection, notFoundSection].forEach(
